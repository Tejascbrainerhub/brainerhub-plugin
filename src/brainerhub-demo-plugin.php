 ...
 * @subpackage brainerhub-demo-plugin/includes
 * @author     Justin Vogt <mail@juvo-design.de>
 */
class brainerhub-demo-plugin
{

    const PLUGIN_NAME = 'brainerhub-demo';
    ...
    {
        $entrypoints_manifest = BRAINERHUB-DEMO-PLUGIN_PATH . '/dist/entrypoints.json';
                ...
                foreach ($files as $file) {
                    if ($type == "js") {
                        wp_enqueue_script(
                            ...
                            BRAINERHUB-DEMO-PLUGIN_URL . 'dist/' . $file,
                            $bundle->dependencies ?? [],
                            null,
                            true,
                        );
