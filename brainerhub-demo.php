<?php
/**
 * Plugin Name: Brainerhub Demo Plugin
 * Description: This is a short description of what the plugin does. It's displayed in the WordPress admin area.
 * Version: 1.0.0
 * Requires PHP: 7.4
 * License: GPL-2.0+
 * License URI: http://www.gnu.org/licenses/gpl-2.0.txt
 * Text Domain: brainerhub-demo
 * Domain Path: /languages
 * 
 * @link              https://juvo-design.de
 * @since             1.0.0
 * @package           brainerhub-demo-plugin
 */

namespace Brainerhub_Demo_Plugin;
 ...
 */
define('BRAINERHUB_DEMO_PLUGIN_PATH', plugin_dir_path(__FILE__));
define('BRAINERHUB_DEMO_PLUGIN_URL', plugin_dir_url(__FILE__));

/**
 * The code that runs during plugin activation.
 */
function activate_brainerhub_demo() {
    Activator::activate();
    // Ensure ACF is available
    if (function_exists('acf_add_local_field_group')) {
        // Include your ACF field group definitions
        include_once BRAINERHUB_DEMO_PLUGIN_PATH . 'acf-field-groups.php';
        // Sync field groups
        acf()->json->sync();
    }
}
 ...
 */
function deactivate_brainerhub_demo() {
...
register_activation_hook(__FILE__, 'Brainerhub_Demo_Plugin\activate_brainerhub_demo');
register_deactivation_hook(__FILE__, 'Brainerhub_Demo_Plugin\deactivate_brainerhub_demo');
...
add_action( 'init', 'Brainerhub_Demo_Plugin\custom_private_post_type', 0 );
...
add_action('acf/init', 'Brainerhub_Demo_Plugin\register_hello_world_block');
